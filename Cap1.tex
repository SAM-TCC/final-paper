...
Desenvolver um protótipo vestível de monitoramento do sono para a detecção de apnéia com comunicação remota para smartphone, tratamento de dados em servidor e disponibilização de dados tratados por meio de dashboards e gráficos em aplicativo mobile e web.
